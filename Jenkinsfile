        ...
        stage('Test') {
            steps {
                script {
                    ...
                    sh 'docker-compose -f /mnt/myApp/docker-compose.yml --env-file /mnt/myApp/.env run -w /var/www/html app composer require --dev phpunit/phpunit:^9.5 phpunit/php-code-coverage:^9.2.9 phpunit/php-file-iterator:^3.0.3 phpunit/php-invoker:^3.1.1 phpunit/php-text-template:^2.0.2 sebastian/code-unit-reverse-lookup:^2.0.2 --ignore-platform-reqs'
